...
public class AirportDataRSController {
    ...
    public AirportDataRSController(AirportDataRouteSearchInputBoundary interactor) {
        this.interactor = interactor;
    }

    public void searchRoute(String takeOffAirport, String landingAirport) {
        final AirportDataRouteSearchInputData inputData = new AirportDataRouteSearchInputData(takeOffAirport,
                landingAirport);
